  ...
  return (
    <div className="page">
      ...
      <section className="section">
        ...
        <div className="table-wrap">
          <table>
            ...
            <tbody>
              <tr>
                <td>形式</td>
                <td>五肢択一式のマークカード方式。記述も実技もない</td>
              </tr>
              <tr>
                <td>問題数・時間</td>
                <td>45 問を 2 時間 30 分。法令 15 問 / 物理学及び化学 10 問 / 性消 20 問</td>
              </tr>
              <tr>
                <td>実施</td>
                <td>都道府県ごと。全国一斉ではなく、回数も日程も県によって違う</td>
              </tr>
              <tr>
                <td>受験資格</td>
                <td>
                  <strong>あります。</strong>
                  化学系の学科等の卒業、化学の 15 単位以上の修得、乙種免状 + 実務経験 2 年以上、
                  乙種を 4 種類以上、修士・博士のいずれか
                </td>
              </tr>
              <tr>
                <td>受験手数料</td>
              ...
              <tr>
                <td>科目免除</td>
                <td><strong>ありません。</strong>乙種と違い、甲種はどの科目も免除されません</td>
              </tr>
              <tr>
                <td>合格基準</td>
                <td>
                  <strong>試験科目ごとに 60 % 以上</strong>。合計点ではない
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <p className="hint">
          <strong>3 科目それぞれで 6 割が必要です。</strong>合計点ではないので、
          いちばん低い科目がそのまま合否を決めます。「法令を捨てて物化で稼ぐ」は成り立ちません。
        </p>
        <p className="hint">
          ※ この表は 2026 年 9 月 15 日時点のものです。試験日程は都道府県ごとに違い、要項も改訂されます。
          申し込みの前に、受験する県の消防試験研究センター支部の案内で確認してください。
        </p>
      </section>
    </div>
  );
